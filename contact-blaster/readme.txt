...
1. Configurtaion form shown when you click the "Insert Contact Form" button


== Changelog ==

= 2.1 =
* Above-editor button opens an overlay with textboxes for entry of SQS mailto: details
* Encoding of email addresses in mailto: links generated by the "Insert Contact Form" button
* Added PHPDoc details
